...
def upgrade(migrate_engine):
    ...
    post_meta.tables['email'].columns['google_message_id'].create()
    post_meta.tables['email'].columns['google_thread_id'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['email'].columns['google_message_id'].drop()
    post_meta.tables['email'].columns['google_thread_id'].drop()
