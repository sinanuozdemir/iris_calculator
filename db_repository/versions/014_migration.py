...
def upgrade(migrate_engine):
    ...
    post_meta.tables['visit'].columns['is_mobile'].create()
    post_meta.tables['visit'].columns['is_pc'].create()
    post_meta.tables['visit'].columns['is_tablet'].create()
    post_meta.tables['visit'].columns['user_agent'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['visit'].columns['is_mobile'].drop()
    post_meta.tables['visit'].columns['is_pc'].drop()
    post_meta.tables['visit'].columns['is_tablet'].drop()
    post_meta.tables['visit'].columns['user_agent'].drop()
