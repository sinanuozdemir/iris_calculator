...
app = Table('app', post_meta,
    ...
    Column('currently_being_handled', Boolean, default=ColumnDefault(False)),
    Column('settings', String(length=1024)),
)
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['app'].columns['settings'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['app'].columns['settings'].drop()
