...
email = Table('email', post_meta,
    ...
    Column('replied_to', Integer),
    Column('legion_cadence_id', Integer),
    Column('legion_template_id', Integer),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['email'].columns['legion_cadence_id'].create()
    post_meta.tables['email'].columns['legion_template_id'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['email'].columns['legion_cadence_id'].drop()
    post_meta.tables['email'].columns['legion_template_id'].drop()
