...
visit = Table('visit', post_meta,
    ...
    Column('after', String(length=1024)),
    Column('gets', String(length=1024)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['visit'].columns['after'].create()
    post_meta.tables['visit'].columns['base'].create()
    post_meta.tables['visit'].columns['gets'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['visit'].columns['after'].drop()
    post_meta.tables['visit'].columns['base'].drop()
    post_meta.tables['visit'].columns['gets'].drop()
